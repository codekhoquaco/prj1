                  ...
                  <div class="col-md-2 col-sm-2">
                     <div class="logo">
                        <a href="{{ route('user.home') }}">
                           <img src="{{ asset("asset/client/images/" . setting_website()->logo) }}" alt="quanaoshop">
                        </a>
                     </div>
                  </div>
                  <div class="col-md-10 col-sm-10">
                     <div class="header_top">
                        <div class="row">
                           <div class="col-md-6">
                              <!--<ul class="topmenu">
                                 <li><a href="https://www.facebook.com/duclong213"><i class="fab fa-facebook"></i></a></li>
                                 <li><a href="#"><i class="fab fa-youtube"></i></a></li>
                                 <li><a href="https://www.instagram.com/vuduclong.2004/"><i class="fab fa-instagram-square"></i></a></li>
